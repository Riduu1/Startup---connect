    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/auth/register`, {
        ...
        body: JSON.stringify({
          ...
          role: formData.role === "founder" ? "Startup Owner" : "Investor"
        })
      });
    ...
    <Layout>
      <div className="min-h-screen bg-gradient-hero flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <Card className="border-0 shadow-hero bg-white/95 backdrop-blur-sm">
            <CardHeader className="space-y-1 text-center">
              <CardTitle className="text-3xl font-bold bg-gradient-primary bg-clip-text text-transparent">
                Join Startup-Connect
              </CardTitle>
              <CardDescription className="text-muted-foreground">
                Create your account and start connecting with the startup ecosystem
              </CardDescription>
            </CardHeader>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="founder" className="text-sm">Startup Founder</Label>
                    </div>
                    <div className="flex items-center space-x-2">
